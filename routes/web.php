...
Route::group(['prefix' => '/route'], function () {
    ...
    Route::get('/tower', ['as' => 'tower', 'uses' => 'TowerController@index']);
    Route::get('/battle', ['as' => 'coinflip', 'uses' => 'CoinFlipController@index']);
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => '/route'], function () {
        ...
        //Route::get('/profile', ['as' => 'home', 'uses' => 'PagesController@index']);

        Route::group(['prefix' => 'profile'], function () {
            Route::get('/', ['as' => 'profile.index', 'uses' => 'ProfileController@myProfile']);
            Route::get('/history', ['as' => 'profile.history', 'uses' => 'PagesController@profileHistory']);
            //Route::post('/change-password', ['as' => 'profile.changePWD', 'uses' => 'ProfileController@changePassword']);
        });
    });

    Route::group(['prefix' => 'profile'], function () {
        Route::get('/', ['as' => 'profile.index', 'uses' => 'ProfileController@myProfileLayout']);
        Route::get('/history', ['as' => 'profile.history', 'uses' => 'PagesController@profileHistoryLayout']);
        Route::post('/change-password', ['as' => 'profile.changePWD', 'uses' => 'ProfileController@changePassword']);
    });
...
Route::group(['prefix' => '/api', 'middleware' => 'secretKey'], function () {
    ...
    Route::group(['prefix' => '/bgaming'], function () {
        Route::post('/play', 'SlotsController@bgaming');
        Route::post('/rollback', 'SlotsController@bgaming');
        Route::get('/start/{game}/{demo}/{client}', 'SlotsController@newGame');
    });
...
Route::get('/{page}', ['as' => 'indexSite', 'uses' => 'PagesController@layout']);
