...
class PagesController extends Controller
{
    ...
    public function __construct(PaymentsProviders $paymentsProviders, DiceController $dice, DoubleController $double, WheelController $wheel, CrashController $crash, CoinFlipController $battle)
    {
        parent::__construct();
    ...
    public function layout($page) {
        ...
        // if($page == 'dice') {
        //     $pagination = $this->dice->index();
        // } else if($page == 'double') {
        //     $pagination = $this->double->index();
        // } else if($page == 'wheel') {
        //     $pagination = $this->wheel->index();
        // } else if($page == 'crash') {
        //     $pagination = $this->crash->index();
        // } else if($page == 'battle') {
        //     $pagination = $this->battle->index();
        // } else {
        //     $pagination = view('pages.home');
        // }
        return view('layout', compact('pagination'));
    }

    public function home()
    {   
        
        //$jogos = ['AlienFruits', 'AllLuckyClover', 'AllLuckyClover100', 'AllLuckyClover20', 'AllLuckyClover40', 'AllLuckyClover5', 'AlohaKingElvis', 'AmericanRoulette', 'AnonymousBonanza', 'Avalon', 'AztecMagic', 'AztecMagicBonanza', 'AztecMagicDeluxe', 'AztecMagicMegaways', 'Baccarat', 'BCBonanza', 'BCMillion', 'BeerBonanza', 'BetfuryMillion', 'BigAtlantisFrenzy', 'BitcoinMillion', 'BitslerBookOfCats', 'BitslerMillion', 'BitstarzBillion', 'BittysDice', 'BlackjackPro', 'BlackjackSurrender', 'BlazeBonanza', 'BlazeMillion', 'BobsCoffeeShop', 'BonanzaBillion', 'BookOfBlaze', 'BookOfCats', 'BookOfCatsMegaways', 'BookOfKemet', 'BookOfKingBilly', 'BookOfMBit', 'BookOfPyramids', 'BraveViking', 'BurningChilliX', 'CandyMonsta', 'CaribbeanPoker', 'CasinobuckMillions', 'CasinoHoldem', 'CherryFiesta', 'CleopatraMillion', 'CloverBonanza', 'CoinslottyCoin', 'CoinslottyMines', 'CoinslottyPlinko', 'CoinslottyRocketDice', 'Crash', 'CrazyStarter', 'DeepSea', 'DesertTreasure', 'DigDigDigger', 'Domnitors', 'DomnitorsDeluxe', 'DomnitorsTreasure', 'DoubleExposure', 'DragonsGold100', 'DragonsMillion', 'EasterHeist', 'EasterPlinko', 'ElvisFrog', 'ElvisFrogAndGoldenCrown', 'ElvisFrogAtJokaRoom', 'ElvisFrogAtTheJokaParty', 'ElvisFrogInBitvegas', 'ElvisFrogInBizzo', 'ElvisFrogInCasinoRocket', 'ElvisFrogInLevelUpCasino', 'ElvisFrogInNationalcasino', 'ElvisFrogInPlayamo', 'ElvisFrogInSpinago', 'ElvisFrogInSpinSamurai', 'ElvisFrogInSyndicate', 'ElvisFrogInWooCasino', 'ElvisFrogTrueways', 'ElvisFrogTwentyBet', 'EuropeanBlackjack', 'EuropeanRoulette', 'FantasyPark', 'FireLightning', 'FortyFruityMillion', 'FourLuckyClover', 'FourLuckyDiamonds', 'FrenchRoulette', 'FruitMillion', 'Gangsterz', 'GiftRush', 'GoldenstarMillion', 'GoldRushWithJohnny', 'HalloweenBonanza', 'HawaiiCocktails', 'HeadsTails', 'HeadsTailsXY', 'HelloEaster', 'HiLoSwitch', 'HitTheRoute', 'HunnyMillion', 'JackpotJillRealmOfFortune', 'JacksOrBetter', 'JogoDoBicho', 'JogoDoBichoSimple', 'JohnnyCash', 'JokerQueen', 'JourneyFlirt', 'KingBillyBonanza', 'KingJohnnieMillions', 'LadyMuertaInSlotvibe', 'LegacyOfCobra', 'LetItRide', 'Limbo', 'LuckyBlue', 'LuckyCrew', 'LuckyDamaMuerta', 'LuckyFarmBonanza', 'LuckyLadyCat', 'LuckyLadyChance', 'LuckyLadyClover', 'LuckyLadyDreams', 'LuckyLadyMoon', 'LuckyLadyMoonMegaways', 'LuckyLadyOneX', 'LuckyLadyPinUp', 'LuckyOak', 'LuckySweets', 'Maneki88Gold', 'MechanicalClover', 'MechanicalOrange', 'MillionJokaFruits', 'Minesweeper', 'MinesweeperXY', 'MissCherryFruits', 'MDbqvjEc5PA2XAoYJWww6BbHFWjRE2NeX5', 'MultihandBlackjack', 'N1Lady', 'N1Million', 'NominiMillion', 'OasisPoker', 'OlimpMillion', 'OneWinMillion', 'ParimatchMillion', 'PasinoBonanza', 'PennyPelican', 'PinUpBonanza', 'PinUpMillion', 'PlatinumLightning', 'PlatinumLightningDeluxe', 'Plinko', 'PlinkoMBit', 'PlinkoOneWin', 'PlinkoXY', 'PokiepopMillion', 'Pontoon', 'PotionSpells', 'PremierMillion', 'PrincessOfSky', 'PrincessRoyal', 'Road2Riches', 'RocketDice', 'RocketDiceXY', 'RocketpotBonanza', 'RoyalHighRoad', 'SavageBuffaloSpirit', 'ScratchDice', 'ScrollOfAdventure', 'SevenBitMillion', 'SicBo', 'SicBoMacau', 'SkeletonSlot', 'SlotmanMillion', 'SlotomonGo', 'SlotticaBonanza', 'Soccermania', 'SpaceXY', 'SpinAndSpell', 'Squidpot', 'StakeBookOfCats', 'StakeMillion', 'TexasHoldem', 'TheKingBillyon', 'TornadoFruits', 'TreyPoker', 'VavadaMillion', 'VbetMillion', 'WbcRingOfRiches', 'WestTown', 'WildCash', 'WildCashX9990', 'WildTexas', 'WildTornadoBonanza', 'YYYMillion', 'ZeusSanctuary'];
        $pagination = view('pages.home');
    ...
    public function profileHistoryLayout() 
    {
        $pagination = $this->profileHistory();
        return view('layout', compact('pagination'));
    }
    ...
    public function pay(Request $r)
    {
        ...
        if ($r->get('type') == 'payeer') {
            ...
            curl_close($ch);
            \Log::info(print_r($providerCredentials,true));
         \Log::info(print_r($response,true));
            ...
            $data_string = json_encode(
                array(
                      "valor"=> $m_amount,
                      "identificacao"=> "BetFyre",
                      "nomePagador"=>$this->user->real_name,
                      "documentoPagador"=>$this->user->cpf,
                      "urlNotificacao"=> "http://" + env('WHITELIST_IP') + "/api/payments/return"
                     )
                );
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL => 'https://api.ezzebank.com/v1/pix/qrcode',
                ...
                'Authentication: JDJ5JDEwJDkucTfdsAvTXhfsdZUFVzVmkuR1ZuNlpkLi5IZ1dnMkhuV2FpVfdsm9HR21zcTlhbfsdfsdExZVzdBV1fdsNya0pT',
                'Content-Type: application/json'
                ),
            ));
            ...
            if ($m_amount != 0) {
                ...
                try {
                    ...
                    $payment->user_id = $this->user->id;
                    $payment->secret = $m_orderid;
                    $payment->order_id = $response['body']['transactionId'];
                    $payment->sum = $m_amount;
                    $payment->system = 'EzBank (PIX)';
                    $payment->extra_info = $response['body']['emvqrcps'];
                    $payment->save();
            ...
            // //print_r($response);
            $url_pay = "/deposit/" . $response['body']['transactionId'];
            return response()->json(['success' => true, 'url' => $url_pay]);
    ...
    public function userWithdraw(Request $r)
    {
        ...
        if ($this->user->balance < $sumCom) return ['success' => false, 'msg' => 'Disponível para saques R$ ' . $this->user->balance . '!', 'type' => 'error'];
    ...
    public function paggue_getBearerToken()
    {
        ...
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, 'https://ms.paggue.io/payments/api/auth/login');
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($ch, CURLOPT_CUSTOMREQUEST, 'POST');
        curl_setopt($ch, CURLOPT_HTTPHEADER, [
            'Content-Type: application/json',
        ]);
        curl_setopt($ch, CURLOPT_POSTFIELDS, "{\n    \"client_key\": \"5351216149591211580\",\n    \"client_secret\": \"55888254217490362\"\n}");
