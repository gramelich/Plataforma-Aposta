...
<div class="swiper game-swiper">
    <div class="swiper-wrapper" style="height: 1rm;">
        ...
        <div class="swiper-slide">
            <div class="game-slide">
                <div class="img-game-slide"
                     style="background-image: url('https://mediumrare.imgix.net/f95b3adf9d28d57496dd8da909c0cb97515104194924c5abb4cc9ad792f35dfe?&dpr=1&format=auto&auto=format&q=50&w=220');">
                    <div class="meta-game-slide hot">hot</div>
                    <div class="meta-game-slide new">new</div>
                </div>
                <div class="hover-game-slide">
                    <div class="h-game-slide">Sweet Bonanza</div>
                    <a href="http://msfyre.live/api/slots/get/7546.html" class="play-game-slide">
                        <svg focusable="false" aria-hidden="true" class="">
                            <use
                                xlink:href="/templates/fuibet/img/betnew/svg-sprite.e1149d9.svg#icon-play"
                                class="svg-use"></use>
                        </svg>
                    </a>
                    <div class="provider-game-slide">
        ...
        <div class="swiper-slide">
            <div class="game-slide">
                <div class="img-game-slide"
                     style="background-image: url('https://mediumrare.imgix.net/abb9098000cde7009fb88c54c26621682110bfbe895818cff2a7b99e7a05a0d3?&dpr=1&format=auto&auto=format&q=50&w=220');">
                    <div class="meta-game-slide hot">hot</div>
                    <div class="meta-game-slide new">new</div>
                </div>
                <div class="hover-game-slide">
                    <div class="h-game-slide">Gates of Olympus</div>
                    <a href="http://msfyre.live/api/slots/get/7760.html" class="play-game-slide">
                        <svg focusable="false" aria-hidden="true" class="">
                            <use
                                xlink:href="/templates/fuibet/img/betnew/svg-sprite.e1149d9.svg#icon-play"
                                class="svg-use"></use>
...
<?php /**PATH /www/wwwroot/msfyre.live/resources/views/pages/home.blade.php ENDPATH**/ ?>