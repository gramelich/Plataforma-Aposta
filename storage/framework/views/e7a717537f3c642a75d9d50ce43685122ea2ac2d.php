        ...
        <div class="index-features2">
            ...
            <div class="banners-slots">
                <?php $__currentLoopData = $jogos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="banner-slot" data-game="<?php echo e($v); ?>"><a href="/api/slots/bgaming/start/<?php echo e($v); ?>/false/desktop" target="_blank"><img src="../img/banners-games/<?php echo e($v); ?>.png"/></a></div>
