    ...
    <?php if(Auth::user() && $u->ban): ?>
        ...
        <?php else: ?>
            ...
            <head>
                ...
                <script type="text/javascript" src="/js/wnoty.js" id="wnoty"></script>
                ...
                <script>
                    ...
                    pageNew = pageNew.replace('/', '');
                    pageNew = pageNew.replace('#', '');
                    console.log(pageNew)
                    if(pageNew == '') pageNew = 'home';
                    ...
                    function route(page) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                //console.log(data)
                                setTimeout(() => {
                                    $('.main-content-top').html(data);
                                    window.history.replaceState({}, document.title, "/"+page)
                                    removeJS(oldPage);
                                    oldPage = page;
                                    console.log(scriptsLoaded.includes(page));
                                    if(!scriptsLoaded.includes(page)) {
                                        var script = document.createElement('script');
                                        script.src = '/js/'+ page +'.js'; // Check https://jquery.com/ for the current version
                                        script.id = page;
                                        document.getElementsByTagName('head')[0].appendChild(script);
                                        scriptsLoaded.push(page);
                                    }
                                }, 1000)
                            },
						...
						function removeJS(filename){
                            try {
                                ...
                                console.log(convertedNodeList.length);
                                const testScript = convertedNodeList.find(script => script.id === filename);
            ...
            <div class="wrapper">
                <div class="header">
                    <div class="logoheader">
                        <a href="#" onclick="route('home')"> <img src="/img/logo_transparent (3).png" width="150px"> </a>
                    </div>
                    ...
                    <div class="left-sidebar">
                        <ul class="side-nav">
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                ...
                                <div class="one-menu">
                                <a href="#" onclick="route('affiliate')">
                                        <div class="img-one-menu">
                                            <svg width="24" height="24" focusable="false" aria-hidden="true" class="">
                                                <use
                            ...
                            <div class="support-menu">
                                <a href="https://jivo.chat/u8eb5mvmCQ" target="_blank">
            ...
            <div class="mobile-nav-component">
                ...
                <div class="mobile-nav-menu-wrapper">
                    <ul class="mobile-nav-menu">
                        ...
                        <?php endif; ?>
                        <li>
                            <a href="https://jivo.chat/u8eb5mvmCQ">
            ...
            <div class="footer">
                ...
                <div class="footer">
                    ...
                    <div class="container-mobile" style="display: none;">
                        <div class="license">
                            <img style="margin-bottom: 8px;" src="/img/logo_transparent (3).png" alt="">
                                                ...
                                                <div class="form-field">
                                                    <div class="input-valid">
                                                        <input class="input-field input-with-icon"
                                                               value="<?php echo e($u->balance); ?>" readonly>
                                                        <div class="input-icon">
                                                        </div>
...
<br><br></span>
            ...
            <script type="text/javascript" src="/js/main.js?v=4">
            </script>

    <?php endif; ?>

<?php endif; ?>
<?php /**PATH /home/chatmidas-cassino/htdocs/cassino.chatmidas.com.br/resources/views/layout.blade.php ENDPATH**/ ?>