...
<div class="section game-section coinflip">
    <div class="container">
        <div class="game">
				...
				<div class="game-block">
					<div class="progress-wrap">
						<div class="progress-item left">
							<div class="title">Mínimo de aposta: <span id="minBet"><?php echo e($settings->flip_min_bet); ?></span> <svg class="icon icon-coin balance"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
							<div class="title">Máximo de aposta: <span id="maxBet"><?php echo e($settings->flip_max_bet); ?></span> <svg class="icon icon-coin balance"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
						</div>
					</div>
...
<?php /**PATH /home/omestrebet/htdocs/omestrebet.com/resources/views/pages/coinflip.blade.php ENDPATH**/ ?>