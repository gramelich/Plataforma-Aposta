			...
			<table class="table table-striped- table-bordered table-hover table-checkable" id="dtable">
				...
				<tbody>
					...
					<tr>
						...
						<td><a class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Editar" data-toggle="modal" href="#edit_<?php echo e($f->id); ?>"><i class="la la-edit"></i></a><a href="/admin/filter/delete/<?php echo e($f->id); ?>" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="APAGAR"><i class="la la-trash"></i></a></td>
					</tr>
        ...
        <div class="modal-content">
            ...
            <form class="kt-form-new" method="post" action="/admin/filter/save">
				...
				<div class="modal-body">
					<div class="form-group">
						<label for="name">Palavra:</label>
						<input type="text" class="form-control" placeholder="insira uma palavra" name="word" value="<?php echo e($f->word); ?>">
					</div>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Voltar</button>
